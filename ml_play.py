            ...
            if self.side == "1P":
                if scene_info["ball_speed"][1] > 0 :
                    ...
                    if scene_info["ball_speed"][0] > 0:
                        ...
                        direction = 3
                X = [scene_info["ball"][0], scene_info["ball"][1],scene_info["platform_1P"][0],scene_info["platform_1P"][1],scene_info["platform_2P"][0],scene_info["platform_2P"][1], direction,scene_info["ball_speed"][0],scene_info["ball_speed"][1]]
